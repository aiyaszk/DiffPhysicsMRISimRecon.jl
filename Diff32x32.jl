# Finite-difference reconstruction of an 32 x 32 density from an accelerated in-vivo brain acquisition
...
iteration_directory = joinpath(@__DIR__, "Diff32x32")
...
function simulation_object(x, params)
    ...
    Phantom(;
        name="32 x 32 in-vivo brain reconstruction",
        x=params.spin_x,
        y=params.spin_y,
        z=params.spin_z,
