# Finite-difference reconstruction of an 16 x 16 density from an accelerated in-vivo brain acquisition
...
iteration_directory = joinpath(@__DIR__, "Diff16x16")
...
function simulation_object(x, params)
    ...
    Phantom(;
        name="16 x 16 in-vivo brain reconstruction",
        x=params.spin_x,
        y=params.spin_y,
        z=params.spin_z,
